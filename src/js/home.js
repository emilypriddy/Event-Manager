...
class Home {
	constructor() {
		...
		this.$experience = document.querySelector('#experience'); // radio button, only the first is stored. Used for resetting the radio buttons, not for reading the value of the selected radio buttons.
